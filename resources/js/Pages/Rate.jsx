                        ...
                        <LegacyCard sectioned>
                            ...
                            {!checkedState.checked1 && (
                                <div style={{ marginTop: "2%" }}>
                                    ...
                                    {checkstate.selectedByCart === 'Type' && (
                                        <div>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '5%' }}>
                                                <Text variant="headingSm" as="h6">
                                                    Multiply line item QTY price:
                                                ...
                                                <div style={{ marginTop: "4%" }}>
                                                    ...
                                                    <div style={{ marginTop: "2%" }}>
                                                        <TextField
                                                            ...
                                                            onChange={() => { }}
                                                            autoComplete="off"
                                                            placeholder='Enter Multiple Product Type Name with Comma Seprate(,)'
                                                            multiline={4}
                                                            monospaced
                                                            helpText='Note: Please enter the exact term of multiple Product Type Name with comma separator(,).'
                                                        />
                                                    </div>
                                                ...
                                                <div style={{ marginTop: "4%" }}>
                                                    ...
                                                    <div style={{ marginTop: "2%" }}>
                                                        <TextField
                                                            ...
                                                            onChange={() => { }}
                                                            autoComplete="off"
                                                            placeholder='Enter Multiple Product  SKU with Comma Seprate(,)'
                                                            multiline={4}
                                                            monospaced
                                                            helpText='Note: Please enter the exact term of multiple Product SKU Name with comma separator(,).'
                                                        />
                                                    </div>
                                                ...
                                                <div style={{ marginTop: "4%" }}>
                                                    ...
                                                    <div style={{ marginTop: "2%" }}>
                                                        <TextField
                                                            ...
                                                            onChange={() => { }}
                                                            autoComplete="off"
                                                            placeholder='Enter Multiple Product collection id with Comma Seprate(,)'
                                                            multiline={4}
                                                            monospaced
                                                            helpText='Note: Please enter the exact term of Product collection id Metafields Name with comma separator(,).'
                                                        />
                                                    </div>
                                                ...
                                                <div style={{ marginTop: "4%" }}>
                                                    ...
                                                    <div style={{ marginTop: "2%" }}>
                                                        <TextField
                                                            ...
                                                            onChange={() => { }}
                                                            autoComplete="off"
                                                            placeholder='Enter Multiple Variant Metafields with Comma Seprate(,)'
                                                            multiline={4}
                                                            monospaced
                                                            helpText='Note: Please enter the exact term of multiple Variant Metafields Name with comma separator(,).'
                                                        />
                                                    </div>
